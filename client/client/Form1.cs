...
namespace client
{
    public partial class Form1 : Form
    {
        ...
        private void buttonReady_Click(object sender, EventArgs e)
        {
            ...
            barche.Add(new Barca(int.Parse(comboBoxRiga4.Text)-1, int.Parse(comboBoxColonna4.Text) - 1, 5, comboBoxOr4.Text == "Orizzontale" ? true : false)); //barca da 4
            barche.Add(new Barca(int.Parse(comboBoxRiga31.Text)-1, int.Parse(comboBoxColonna31.Text) - 1, 5, comboBoxOr31.Text == "Orizzontale" ? true : false)); //barca da 3
            barche.Add(new Barca(int.Parse(comboBoxRiga32.Text) - 1, int.Parse(comboBoxColonna32.Text) - 1, 5, comboBoxOr32.Text == "Orizzontale" ? true : false)); //barca da 3
            barche.Add(new Barca(int.Parse(comboBoxRiga21.Text) - 1, int.Parse(comboBoxColonna21.Text) - 1, 5, comboBoxOr21.Text == "Orizzontale" ? true : false)); //barca da 2
            barche.Add(new Barca(int.Parse(comboBoxRiga22.Text) - 1, int.Parse(comboBoxColonna22.Text) - 1, 5, comboBoxOr22.Text == "Orizzontale" ? true : false)); //barca da 2
